...
- **Sleep length**: This is the recommended sleep duration based on the hours shown above. So, the change in ideal sleep length between **Today** and **Tomorrow** is shown as "06:48 -> 06:52." You can skip the next sentence as it's there for context. Subtracting the hours supplied in **Today** yields the optimum amount of sleep hours for today: `08:07 - 01:18 = 06:48`. The same is true **Tomorrow**: 07:47 - 00:56 = 06:51.
