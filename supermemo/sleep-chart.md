...
Before we explain what each of the buttons do, let's have a look at the [filled example](/supermemo/sleep-chart/filled-timeline.png) above (taken from the official manual).
