...
- In this example, 17 hours from arising, the user is expected to sleep for 7 hours (because that's where the green line crosses the <span style="padding: 3px; color: rgb(255, 255, 255); background-color: red;">red line</span>. See the black arrows which I added to the [screenshot above](/supermemo/sleep-chart/circadian-hrs-arising.png)). Also notice that 17+7=24 hours.
