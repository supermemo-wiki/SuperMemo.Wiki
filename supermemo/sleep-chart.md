...
**Alertness (C)**: this is the circadian alertness, which is a measurement of alertness *with respect to the circadian time*. This is a little trickier to understand, I know.
