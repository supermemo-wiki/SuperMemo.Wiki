...
- Left vertical axis shows the bedtime hours. And, just like in the horizontal axis in the Circadian tab, this axis has two options: hours from arising and clock time.
