...
- Left vertical axis shows the bedtime hours. And, just like in the horizontal axis in the Circadian tab, this axis has two options (which can be modified using the "Switch between absolute hours and relative hours" [button](/supermemo/sleep-chart/phase-shift-tab.png)): hours from arising and clock time.
